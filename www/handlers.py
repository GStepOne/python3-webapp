...
from apis import APIError,APIValueError,APIResourceNotFoundError,Page,APIPermissionError
...
async def api_blogs(*,page='1'):
	...
	blogs = await Blog.findAll(where='status=1',orderBy='created_at desc', limit =(p.offset,p.limit))
...
# '/api/blogs/' + blog.id + '/delete'
@post('/api/blogs/{id}/delete')
async def blogs_delete(*,id):
	blog = await Blog.delete(id,2)
	return blog
